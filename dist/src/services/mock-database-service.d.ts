...
export declare class MockDatabaseService {
    ...
    updateAIEngine(id: string, data: Partial<MockAIEngine>): Promise<MockAIEngine | null | undefined>;
    ...
    updateWorkflowExecution(id: string, data: Partial<MockWorkflowExecution>): Promise<MockWorkflowExecution | null | undefined>;
    ...
    updateUser(id: string, userData: Partial<MockUser>): Promise<MockUser | null | undefined>;
