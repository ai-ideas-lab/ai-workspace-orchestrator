...
exports.clearPerformanceData = exports.getRecentPerformance = exports.getEndpointPerformance = exports.getPerformanceStats = exports.performanceMiddleware = exports.performanceMonitor = void 0;
...
const performanceMiddleware = (req, res, next) => {
    ...
    res.on('finish', () => {
        ...
        exports.performanceMonitor.recordMetric(metric);
    });
    next();
};
...
const getEndpointPerformance = (req, res) => {
    try {
        ...
        const stats = exports.performanceMonitor.getEndpointStats(endpoint);
        res.json({
            success: true,
            data: stats,
            timestamp: new Date().toISOString()
...
exports.getEndpointPerformance = getEndpointPerformance;
const getRecentPerformance = (req, res) => {
    try {
        const limit = parseInt(req.query.limit) || 50;
        const metrics = exports.performanceMonitor.getRecentMetrics(limit);
        res.json({
            success: true,
            data: metrics,
            timestamp: new Date().toISOString()
...
const clearPerformanceData = (req, res) => {
    try {
