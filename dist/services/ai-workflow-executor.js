...
exports.aiWorkflowExecutor = exports.AIWorkflowExecutor = void 0;
...
class AIWorkflowExecutor {
    ...
    async executeAITaskStep(step, executionStep, context) {
        ...
        const task = ai_engine_js_1.aiEngine.executeTask({
            type: taskType,
...
exports.AIWorkflowExecutor = AIWorkflowExecutor;
exports.aiWorkflowExecutor = new AIWorkflowExecutor();
