...
const errorMiddleware_ts_1 = require("./middleware/errorMiddleware.ts");
const errorMiddleware_ts_2 = require("./middleware/errorMiddleware.ts");
...
(0, errorMiddleware_ts_1.setupGlobalErrorMonitoring)();
...
app.use(errorMiddleware_ts_2.requestIdMiddleware);
...
app.use(errorMiddleware_ts_1.notFoundHandler);
app.use(errorMiddleware_ts_1.globalErrorHandler);
server.listen(PORT, () => {
